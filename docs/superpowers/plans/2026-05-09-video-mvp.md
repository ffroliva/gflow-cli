...
If failure: open <https://github.com/ffroliva/flow-cli/actions> and surface the error to the user — most likely "PyPI Trusted Publishing not configured", remediation is to set it up at <https://pypi.org/manage/account/publishing/>.
