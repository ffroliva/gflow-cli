            ...
            if asset_lookup is not None:
                ...
                repo.upsert_local_file(
                    LocalFileRecord(
                        ...
                        path=local_path.resolve() if local_path is not None else None,
                        media_type=media_type,
                        bytes=_file_bytes(local_path) if local_path is not None else None,
                        sha256=_file_sha256(local_path) if local_path is not None else None,
                        storage_provider=(
